...
// images
import phase1 from "./asset/img/roadmap/phase1.png";
    ...
    <div>
      ...
      <header className="home-header-bg animation-section">
        <div
          ...
          data-image-src="assets/img/about-me/webp-banner-blog.webp"
        ></div>
            ...
            <div className="header-page-text">
              <p className="el-anime el-words">
                <span className="el">
                  ...
                  Verse that is built & owned by the community.
                  <img src={phase1} />
                </span>
              </p>
            </div>
        ...
        <div className="social-icon py-5">
          <span className="social-icon-text text-white">Follow Us: </span>
                      ...
                      <div className="ag-timeline-card_inner">
                        ...
                        <div className="ag-timeline-card_info">
                          ...
                          <div className="ag-timeline-card_desc">
                            ...
                            selling 2000 NFT.
                            <br />
                            Note : Only 100 Holders will get Tshirts of Zippo
                            Verse.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="ag-timeline-card_inner">
                        ...
                        <div className="ag-timeline-card_info">
                          ...
                          <div className="ag-timeline-card_desc">
                            ...
                            Verse Holders.
                            <br />3 Random Lucky Winners who hold at least 3 NFT
                            will get 2 ETH each in their wallet through airdrops
                            & another 100 random lucky winners will get 100 USDT
                            each in their wallet through airdrops.
                          </div>
                        </div>
                      </div>
                      <div className="ag-timeline-card_arrow"></div>
                    ...
                    <div className="ag-timeline-card_item">
                      <div className="ag-timeline-card_inner">
                        ...
                        <div className="ag-timeline-card_info">
                          ...
                          <div className="ag-timeline-card_desc">
                            Offering Zippo Verse Holders Collectibles Toys.
                            <br />
                            Only 200 Random holders will get collectibles toys &
                            If any holders who wants to buy collectibles toys
                            they can buy it in Shop section & Shop section will
                            unlock in Phase 5th.
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="ag-timeline-card_inner">
                        ...
                        <div className="ag-timeline-card_info">
                          ...
                          <div className="ag-timeline-card_desc">
                            ...
                            Merchandise section on our Zippo Verse website.
                            <br />A decentralized Store for All.
                          </div>
                        </div>
                      </div>
                      <div className="ag-timeline-card_arrow"></div>
                      ...
                      <div className="ag-timeline-card_inner">
                        ...
                        <div className="ag-timeline-card_info">
                          ...
                          <div className="ag-timeline-card_desc">
                            ...
                            digital Future i.e. Metaverse. While exploring new
                            dimensions. Our aim is to create a virtual space for
                            NFT Holders where they can Meet & interact with each
                            other.
                          </div>
                        </div>
                      </div>
